module github.com/upbound/function-argo-eks-discovery
...
replace github.com/crossplane-contrib/provider-argocd => github.com/haarchri/provider-argocd v0.5.0-rc-2
